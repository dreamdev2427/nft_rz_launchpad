      ...
      <Transition appear show={isOpen} as={Fragment}>
        ...
        >
          <div className="min-h-screen px-1 text-center md:px-4">
            ...
            >
              <div
                className={`inline-block w-full my-5 overflow-hidden text-left align-middle transition-all transform bg-white border border-black border-opacity-5 shadow-xl rounded-2xl sm:my-8 dark:bg-neutral-800 dark:border-neutral-600 text-neutral-900 dark:text-neutral-300 ${contentExtraClass}`}
              >
                {isHeader && (
                  <div className="py-4 px-6 text-center relative border-b border-neutral-100 dark:border-neutral-600 md:py-5">
                    <ButtonClose
                      onClick={closeModal}
